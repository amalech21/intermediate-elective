...
p <- ggplot(data = species_rich_final,
  ...
  labs(
    ...
    caption = "Data derived from ENVS193DD, UCSB",
    x = "Year",
...
colors2 <- scale_color_manual(
  values = c(
      "Devereux Creek" = "#285943",
      "North of Venoco Bridge" = "#D36582",
      "South of Phelps Bridge" = "#82204A",
      "Phelps Road" = "#74546A",
      "South of Venoco Bridge" = "#C490D1",
      "North of Phelps Bridge" = "#FFB7C3",
      "Main Channel" = "#5FB0B7"
  ))
```
